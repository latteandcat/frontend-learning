...
ES6 新增了 Set、Map，以及它们的其他形式 WeakSet、WeakMap
...
[ES9中的异步迭代器（Async iterator）和异步生成器（Async generator） - 掘金 (juejin.cn)](https://juejin.cn/post/6844903735534026765)
